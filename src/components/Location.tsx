    ...
    <section className="py-24 md:py-32 px-6 md:px-12 lg:px-24 bg-zen-beige overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10 items-center">
          ...
          {/* Column 2: Real Entrance Photo (Visual Card) */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.8, delay: 0.1 }}
            className="relative rounded-2xl overflow-hidden shadow-md h-[350px] w-full border border-zen-brown/10"
          >
            <Image
              src="/images/zen-spa-entrada-foto.webp"
              alt="Fachada real de la entrada de Zen Spa Bienestar Roldanillo"
              fill
          ...
          {/* Column 3: Minimalist Map with CTA Button */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="relative group rounded-2xl overflow-hidden shadow-md h-[350px] w-full border border-zen-brown/10"
          >
            {/* Aesthetic Map Image */}
            <Image
            ...
            {/* Subtle overlay & Google Maps CTA */}
            <div className="absolute inset-0 bg-black/20 group-hover:bg-black/35 transition-colors duration-500 flex items-center justify-center p-4 text-center">
              <a 
                href="https://maps.app.goo.gl/mYrofQv99b7zZ7p69" 
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-3 bg-[#3f0c08] text-[#efdbd5] hover:bg-[#efdbd5] hover:text-[#3f0c08] transition-all rounded-full text-xs font-semibold tracking-wider uppercase shadow-md transform group-hover:scale-105 duration-300"
              >
