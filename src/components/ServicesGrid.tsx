...
const services = [
  {
    ...
    image: '/images/portadas-servicios/experiencias-parejas-roldanillo.webp',
  ...
  },
  {
    ...
    image: '/images/portadas-servicios/limpieza-facial-tecnologica-roldanillo.webp',
  ...
  },
  {
    ...
    image: '/images/portadas-servicios/bronceado-brasilero-marquinha-roldanillo.webp',
    className: 'md:col-span-1 md:row-span-1',
    href: '/bronceado',
  },
  {
    ...
    image: '/images/portadas-servicios/spa-infantil-mini-divas-roldanillo.webp',
    className: 'md:col-span-1 md:row-span-1',
    href: '/minidivas',
  },
  {
    ...
    image: '/images/portadas-servicios/bienestar-corporativo-empresas-valle.webp',
    className: 'md:col-span-1 md:row-span-1',
    href: '/corporativo',
  },
  {
    ...
    image: '/images/portadas-servicios/masajes-relajantes-bambuterapia-roldanillo.webp',
    className: 'md:col-span-1 md:row-span-1',
    href: '/masajes',
  },
];
